...
const CreateProject = () => {
  return (
    <div className="fixed flex items-center justify-center w-screen h-screen inset-0 bg-black bg-opacity-50 transform transition-transform duration-300 scale-100">
